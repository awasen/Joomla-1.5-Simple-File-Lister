...
$document->addStyleSheet( $sfl_basepath."mod_simplefilelister.css" );

if ($sfl_jquery == 0) {
	if ($sfl_jqueryinclude == 0)
		$document->addScript( $sfl_basepath."tmpl/jquery-1.4.3.min.js" );
	else
		echo '<script type="text/javascript" src="'.$sfl_basepath.'tmpl/jquery-1.4.3.min.js"></script>';
}
